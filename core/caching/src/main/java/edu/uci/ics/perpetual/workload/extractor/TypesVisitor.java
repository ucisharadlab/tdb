...
public class TypesVisitor implements SelectVisitor, FromItemVisitor, ExpressionVisitor, ItemsListVisitor, SelectItemVisitor, StatementVisitor {
    ...
    @Override
    public void visit(CreateObservingFunction createObservingFunction) {
