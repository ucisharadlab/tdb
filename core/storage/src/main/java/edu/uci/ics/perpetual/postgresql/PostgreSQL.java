package edu.uci.ics.perpetual.postgresql;
...
public class PostgreSQL implements StorageManager {
    ...
    private static PostgreSQL storage;
    ...
    public static PostgreSQL getInstance(SchemaManager schemaManager) {
        if (storage == null) {
